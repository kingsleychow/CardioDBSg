...
CREATE TABLE `BiobankRecords` (
  ...
  KEY `Gender` (`Gender`),
  KEY `Race` (`Race`)
) ENGINE=InnoDB AUTO_INCREMENT=1114 DEFAULT CHARSET=utf8 COMMENT='Disease diagnostic result from Biobank database (obtain from NHCS intranet - manual update weekly).';
...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='Pre-fill table - Description of desease''s diagnostic code.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8 COMMENT='Origin place of received samples.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-04-09 12:00:18
