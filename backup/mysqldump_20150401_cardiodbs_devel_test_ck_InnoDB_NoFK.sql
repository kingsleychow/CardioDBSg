...
) ENGINE=InnoDB AUTO_INCREMENT=38497 DEFAULT CHARSET=utf8 COMMENT='Information extract from coverage report - PerOfCallableBy_ProteinCodingTarget_runname_poolname.txt. CodingEnrichments.sample_id=Samples.id.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `GATKs` (
  ...
  KEY `sample_id_only` (`sample_id`),
  KEY `filter` (`filter`)
) ENGINE=InnoDB AUTO_INCREMENT=17430 DEFAULT CHARSET=utf8 COMMENT='Information extract from result of GATK UnifiedGenotyper - samplename.markDup.Realigned.recalibrated.OnTarget.q15.bam.final.UnifiedGenotyper.snp.vcf and indel.vcf. GATKs.sample_id=Samples.id. GATKs.chr=_UnifiedCalls.chr & GATKs.v_start=_UnifiedCalls.v_start & GATKs.v_end=_UnifiedCalls.v_end & GATKs.reference=_UnifiedCalls.reference & GATKs.genotype=_UnifiedCalls.genotype';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `GATKsHC` (
  ...
  KEY `sample_id_only` (`sample_id`),
  KEY `filter` (`filter`)
) ENGINE=InnoDB AUTO_INCREMENT=17662 DEFAULT CHARSET=utf8 COMMENT='Information extract from result of GATK HaplotypeCaller - samplename.markDup.Realigned.recalibrated.OnTarget.q15.bam.final.HaplotypeCaller.snp.vcf and indel.vcf. GATKsHC.sample_id=Samples.id. GATKsHC.chr=_UnifiedCalls.chr & GATKsHC.v_start=_UnifiedCalls.v_start & GATKsHC.v_end=_UnifiedCalls.v_end & GATKsHC.reference=_UnifiedCalls.reference & GATKsHC.genotype=_UnifiedCalls.genotype.';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='Information extract from coverage report - SummaryOutput_ProteinCodingTarget_runname.txt. SampleEnrichments.sample_id=Samples.id.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'cardiodbs_devel_test_ck'
--
...
-- Dump completed on 2015-04-01 19:17:12
