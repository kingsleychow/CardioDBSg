...
--
-- Table structure for table `BiobankRecords`
--

DROP TABLE IF EXISTS `BiobankRecords`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `BiobankRecords` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sample_name` varchar(100) NOT NULL,
  `DOB` date DEFAULT NULL,
  `Gender` enum('M','F') DEFAULT NULL,
  `Race` varchar(10) DEFAULT NULL,
  `c_diag_code` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `sample_name` (`sample_name`),
  KEY `diag_code` (`c_diag_code`),
  KEY `DOB` (`DOB`),
  KEY `Gender` (`Gender`),
  KEY `Race` (`Race`)
) ENGINE=InnoDB AUTO_INCREMENT=8760 DEFAULT CHARSET=utf8 COMMENT='Disease diagnostic result from Biobank database (obtain from NHCS intranet - manual update weekly).';
...
CREATE TABLE `Callers` (
  ...
  `caller` enum('Ensembl','GATK','LifeScope','Samtools','TorrentSuite','cgatools','UniProt','COSMIC','HGMD','dbNSFP') NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='Pre-fill table - to store the version of software/database used either for variant calling or annotations. Callers.id=Sample2Callers.caller_id.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=558776 DEFAULT CHARSET=utf8 COMMENT='Information extract from coverage report - PerOfCallableBy_ProteinCodingTarget_runname_poolname.txt. CodingEnrichments.sample_id=Samples.id.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Diseases` (
  ...
  `diag_code` varchar(50) DEFAULT NULL,
  `des` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `diag_code_UNIQUE` (`diag_code`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='Pre-fill table - Description of desease''s diagnostic code.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=241259 DEFAULT CHARSET=utf8 COMMENT='Information extract from result of GATK UnifiedGenotyper - samplename.markDup.Realigned.recalibrated.OnTarget.q15.bam.final.UnifiedGenotyper.snp.vcf and indel.vcf. GATKs.sample_id=Samples.id. GATKs.chr=_UnifiedCalls.chr & GATKs.v_start=_UnifiedCalls.v_start & GATKs.v_end=_UnifiedCalls.v_end & GATKs.reference=_UnifiedCalls.reference & GATKs.genotype=_UnifiedCalls.genotype';
/*!40101 SET character_set_client = @saved_cs_client */;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`cardiodbs`@`127.0.0.1`*/ /*!50003 TRIGGER `insert_UnifiedCalls_after_GATKs` AFTER INSERT ON `GATKs` FOR EACH ROW
BEGIN
...
) ENGINE=InnoDB AUTO_INCREMENT=247516 DEFAULT CHARSET=utf8 COMMENT='Information extract from result of GATK HaplotypeCaller - samplename.markDup.Realigned.recalibrated.OnTarget.q15.bam.final.HaplotypeCaller.snp.vcf and indel.vcf. GATKsHC.sample_id=Samples.id. GATKsHC.chr=_UnifiedCalls.chr & GATKsHC.v_start=_UnifiedCalls.v_start & GATKsHC.v_end=_UnifiedCalls.v_end & GATKsHC.reference=_UnifiedCalls.reference & GATKsHC.genotype=_UnifiedCalls.genotype.';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`cardiodbs`@`127.0.0.1`*/ /*!50003 TRIGGER `insert_UnifiedCalls_after_GATKsHC` AFTER INSERT ON `GATKsHC` FOR EACH ROW
BEGIN
	INSERT IGNORE INTO _UnifiedCalls
	SET chr=new.chr, v_start=new.v_start, v_end=new.v_end, reference=new.reference, genotype=new.genotype;
END */;;
...
--
-- Table structure for table `GeneticLabRecords`
--

DROP TABLE IF EXISTS `GeneticLabRecords`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GeneticLabRecords` (
  `id` int(5) unsigned NOT NULL AUTO_INCREMENT,
  `sample_name` varchar(100) NOT NULL,
  `Race` varchar(10) DEFAULT NULL,
  `Gender` enum('M','F') DEFAULT NULL,
  `DOB` date DEFAULT NULL,
  `ReferringHospital` varchar(45) NOT NULL,
  `referrerLocalID` varchar(45) DEFAULT NULL,
  `purpose` varchar(45) DEFAULT NULL,
  `description` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `sample_name_UNIQUE` (`sample_name`),
  KEY `race_only` (`Race`),
  KEY `hospital_only` (`ReferringHospital`),
  KEY `gender_only` (`Gender`)
) ENGINE=InnoDB AUTO_INCREMENT=258 DEFAULT CHARSET=utf8 COMMENT='Origin place of received samples.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='Information from sequencing run. Runs.id=Samples.run_id';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Sample2Callers` (
  ...
  CONSTRAINT `fk_Sample2Callers_Samples1` FOREIGN KEY (`sample_id`) REFERENCES `Samples` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=349 DEFAULT CHARSET=utf8 COMMENT='Row filled by Samples table trigger. To link which samples are called or annotated by which (version of) caller or external sources. Samples2Callers.sample_id=Samples.id. Samples2Callers.caller_id=Callers.id.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `SampleEnrichments` (
  ...
  `cov_50x_pct` float(5,2) NOT NULL,
  ...
  `diff_mean-med` float(5,2) NOT NULL,
  ...
  `Total_HC_HetSNPs` int(5) DEFAULT NULL,
  `HetSNPs_AB_0.4_0.6` int(5) DEFAULT NULL,
  `HetSNPs_AB_0.4_0.6_pct` float(5,2) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=175 DEFAULT CHARSET=utf8 COMMENT='Information extract from coverage report - SummaryOutput_ProteinCodingTarget_runname.txt. SampleEnrichments.sample_id=Samples.id.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `SampleStatus` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `sample_id_UNIQUE` (`sample_id`),
  CONSTRAINT `fk_SampleStatus_Samples1` FOREIGN KEY (`sample_id`) REFERENCES `Samples` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=175 DEFAULT CHARSET=utf8 COMMENT='Row filled by Samples table trigger. A QC for samples. Non-OK = ?';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Samples` (
  ...
  `no_r1_qc` int(30) NOT NULL,
  `no_r2_cfilter` int(30) DEFAULT NULL,
  `no_r2_qc` int(30) DEFAULT NULL,
  `no_rp_qc` int(30) DEFAULT NULL,
  `ControlStatus` enum('0','1','2') DEFAULT NULL,
  ...
  KEY `control_only` (`ControlStatus`),
  KEY `category_only` (`Category`),
...
) ENGINE=InnoDB AUTO_INCREMENT=175 DEFAULT CHARSET=utf8 COMMENT='Information for sequencing samples. Two triggers related with this table.';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`cardiodbs`@`127.0.0.1`*/ /*!50003 TRIGGER `set_sample_status_before_insert` BEFORE INSERT ON `Samples` FOR EACH ROW 
BEGIN
	set @status='NA';
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`cardiodbs`@`127.0.0.1`*/ /*!50003 TRIGGER `insert_sample2callers_sample_status_after_insert` AFTER INSERT ON `Samples` FOR EACH ROW
BEGIN
	insert ignore into Sample2Callers (sample_id,caller_id)
		...
		AND (CASE r.machine
			...
			WHEN 'NextSeq 500' THEN c.caller!='LifeScope' AND c.caller!='TorrentSuite' AND c.caller!='cgatools'
		END);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Information extract from result of samtools - samplename.markDup.Realigned.recalibrated.OnTarget.q15.bam.samtools.flt.vcf. Samtools.sample_id=Samples.id. Samtools.chr=_UnifiedCalls.chr and Samtools.v_start=_UnifiedCalls.v_start and Samtools.v_end=_UnifiedCalls.v_end and Samtools.reference=_UnifiedCalls.reference and Samtools.genotype=_UnifiedCalls.genotype.';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`cardiodbs`@`127.0.0.1`*/ /*!50003 TRIGGER `insert_UnifiedCalls_after_Samtools` AFTER INSERT ON `Samtools` FOR EACH ROW
begin
	INSERT ignore INTO _UnifiedCalls
	set chr=new.chr, v_start=new.v_start, v_end=new.v_end, reference=new.reference, genotype=new.genotype;
end */;;
...
CREATE TABLE `Targets` (
  ...
  `description` varchar(255) DEFAULT NULL,
  `target_gene_no` int(5) DEFAULT NULL,
  `probe_no` int(5) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `target_id_UNIQUE` (`target_code`),
  UNIQUE KEY `target_name_UNIQUE` (`target_name`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Pre-fill table - assay information for target capture. Targets.id=Samples.target_id.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `V2Ensembls` (
  ...
  `sift` enum('tolerated','deleterious','tolerated - low confidence','deleterious - low confidence') DEFAULT NULL,
  ...
  `evidence_status` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=121914 DEFAULT CHARSET=utf8 COMMENT='To store Ensembl VEP annotations. V2Ensembls.uid=_UnifiedCalls.id. V2Ensembls.id=V2Families.vid. V2Ensembls.id=_ClassifiedCalls.vid.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `V2Freqs` (
  ...
  `pop_name` varchar(500) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uid_rsid_allele_popid` (`uid`,`rs_id`,`allele`(200),`pop_id`),
  KEY `uid_only` (`uid`),
  KEY `rs_id_only` (`rs_id`),
  KEY `pop_id_name` (`pop_id`,`pop_name`(200)),
  CONSTRAINT `fk_V2Freqs__UnifiedCalls1` FOREIGN KEY (`uid`) REFERENCES `_UnifiedCalls` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=438567 DEFAULT CHARSET=utf8 COMMENT='To store variant allele frequency. pop_id is from the population table of Ensembl Variation DB.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1023 DEFAULT CHARSET=utf8 COMMENT='Phenotype annotations from Ensembl.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `V2dbNSFP` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uid_nsfp` (`uid`,`nsfp_id`),
  KEY `uid_only` (`uid`),
...
) ENGINE=InnoDB AUTO_INCREMENT=1645 DEFAULT CHARSET=utf8 COMMENT='Variants annotated by dbNSFP. ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `V2dbSNPs` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uid_rs_id` (`uid`,`rs_id`),
  KEY `uid_only` (`uid`),
  KEY `rs_id_only` (`rs_id`),
  CONSTRAINT `fk_V2dbSNPs__UnifiedCalls1` FOREIGN KEY (`uid`) REFERENCES `_UnifiedCalls` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=10153 DEFAULT CHARSET=utf8 COMMENT='Variants annotated by dbSNPs. V2dbSNPs.uid=_UnifiedCalls.id.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `_MetaCalls` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `sample_id_uid` (`sample_id`,`uid`),
  KEY `sample_id_only` (`sample_id`),
  KEY `uid_only` (`uid`),
  KEY `gatk_only` (`gatk`),
...
) ENGINE=InnoDB AUTO_INCREMENT=189707 DEFAULT CHARSET=utf8 COMMENT='This table is a short-cut of joined results from Samples, _UnifiedCalls and various callers. _MetaCalls.sample_id=Samples.id. _MetaCalls.uid=_UnifiedCalls.id. _MetaCalls.gatk=GATKs.id';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `_UnifiedCalls` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `chr_start_end_ref_gen` (`chr`,`v_start`,`v_end`,`reference`(160),`genotype`(160)),
  KEY `chr_only` (`chr`),
  KEY `in_ensembl` (`in_ensembl`),
  KEY `is_new` (`is_new`)
) ENGINE=InnoDB AUTO_INCREMENT=11201 DEFAULT CHARSET=utf8 COMMENT='Trigger-filled table - summarize variant information from different caller tables. To consolidate and merge variants regardless of callers. _UnifiedCalls.id=_MetaCalls.uid. _UnifiedCalls.id=V2Ensembls.uid. _UnifiedCalls.id=2PDBs.uid. _UnifiedCalls.id=2UniProts.uid. _UnifiedCalls.id=HasFound.uid. _UnifiedCalls.id=V2dbNSFP.uid.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `core` (
  ...
  `refaa` char(1) DEFAULT NULL,
  `aaalt` char(1) DEFAULT NULL,
  `rs_dbSNP138` varchar(150) DEFAULT NULL,
  `hg18_pos` int(11) DEFAULT NULL,
  `gene` varchar(500) DEFAULT NULL,
  `uniprot_acc` varchar(500) DEFAULT NULL,
  `uniprot_id` varchar(500) DEFAULT NULL,
  `uniprot_aapos` varchar(500) DEFAULT NULL,
  `interpro` varchar(500) DEFAULT NULL,
  `cds_strand` varchar(20) DEFAULT NULL,
  `refcodon` varchar(150) DEFAULT NULL,
  `SLR_test_statistic` float DEFAULT NULL,
  `codonpos` varchar(10) DEFAULT NULL,
  `fold_deg` varchar(100) DEFAULT NULL,
  `anc_allele` varchar(3) DEFAULT NULL,
  `ensg` varchar(500) DEFAULT NULL,
  `enst` varchar(1000) DEFAULT NULL,
  `aapos` varchar(500) DEFAULT NULL,
  `aapos_SIFT` varchar(100) DEFAULT NULL,
  `aapos_FATHMM` varchar(1500) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `chr` (`chr`,`pos`,`ref`,`refaa`,`alt`,`aaalt`),
  KEY `chr_2` (`chr`,`pos`,`ref`,`alt`),
  KEY `chr_3` (`chr`,`pos`),
  KEY `gene` (`gene`(100)),
  KEY `ref_alt` (`ref`,`alt`),
  KEY `ref` (`ref`),
  KEY `alt` (`alt`),
  KEY `pos` (`pos`),
  KEY `pos_ref_alt` (`pos`,`ref`,`alt`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `projectas`
--

DROP TABLE IF EXISTS `projectas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `projectas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `participationid` varchar(255) NOT NULL,
  `project_id` int(11) DEFAULT NULL,
  `study_pk` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2057 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping routines for database 'cardiodbs_devel'
--
...
BEGIN
	...
	ELSEIF (my_platform='MiSeq' OR my_platform='HiSeq' OR my_platform='454' OR my_platform='software' OR my_platform='NextSeq 500') THEN
...
-- Dump completed on 2016-03-01 16:15:42
