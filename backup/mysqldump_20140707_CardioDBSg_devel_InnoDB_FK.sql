...
CREATE TABLE `Sample2Callers` (
  ...
  CONSTRAINT `fk_Sample2Callers_Callers1` FOREIGN KEY (`caller_id`) REFERENCES `Callers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Samples` (
  ...
  CONSTRAINT `fk_Samples_Targets1` FOREIGN KEY (`target_id`) REFERENCES `Targets` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
...
-- Dump completed on 2014-07-08 14:55:52
