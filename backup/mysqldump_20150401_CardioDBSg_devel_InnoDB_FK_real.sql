...
CREATE TABLE `BiobankRecords` (
  ...
  KEY `Gender` (`Gender`),
  KEY `Race` (`Race`)
) ENGINE=InnoDB AUTO_INCREMENT=878 DEFAULT CHARSET=utf8 COMMENT='Disease diagnostic result from Biobank database (obtain from NHCS intranet - manual update weekly).';
...
-- Dump completed on 2015-04-01 19:16:45
