...
CREATE TABLE `Diseases` (
  ...
  CONSTRAINT `fk_Diseases_BiobankRecords1` FOREIGN KEY (`diag_code`) REFERENCES `BiobankRecords` (`c_diag_code`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2014-12-23 11:48:03
