...
--
-- Host: 127.0.0.1    Database: cardiodbs_devel_test_ck
-- ------------------------------------------------------
...
CREATE TABLE `BiobankRecords` (
  ...
  KEY `Gender` (`Gender`),
  KEY `Race` (`Race`)
) ENGINE=InnoDB AUTO_INCREMENT=1755 DEFAULT CHARSET=utf8 COMMENT='Disease diagnostic result from Biobank database (obtain from NHCS intranet - manual update weekly).';
...
CREATE TABLE `CodingEnrichments` (
  ...
  KEY `sample_name` (`sample_name`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Information extract from coverage report - PerOfCallableBy_ProteinCodingTarget_runname_poolname.txt. CodingEnrichments.sample_id=Samples.id.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Pre-fill table - Description of desease''s diagnostic code.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `GATKs` (
  ...
  KEY `sample_id_only` (`sample_id`),
  KEY `filter` (`filter`)
) ENGINE=InnoDB AUTO_INCREMENT=67169 DEFAULT CHARSET=utf8 COMMENT='Information extract from result of GATK UnifiedGenotyper - samplename.markDup.Realigned.recalibrated.OnTarget.q15.bam.final.UnifiedGenotyper.snp.vcf and indel.vcf. GATKs.sample_id=Samples.id. GATKs.chr=_UnifiedCalls.chr & GATKs.v_start=_UnifiedCalls.v_start & GATKs.v_end=_UnifiedCalls.v_end & GATKs.reference=_UnifiedCalls.reference & GATKs.genotype=_UnifiedCalls.genotype';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `GATKsHC` (
  ...
  KEY `sample_id_only` (`sample_id`),
  KEY `filter` (`filter`)
) ENGINE=InnoDB AUTO_INCREMENT=68065 DEFAULT CHARSET=utf8 COMMENT='Information extract from result of GATK HaplotypeCaller - samplename.markDup.Realigned.recalibrated.OnTarget.q15.bam.final.HaplotypeCaller.snp.vcf and indel.vcf. GATKsHC.sample_id=Samples.id. GATKsHC.chr=_UnifiedCalls.chr & GATKsHC.v_start=_UnifiedCalls.v_start & GATKsHC.v_end=_UnifiedCalls.v_end & GATKsHC.reference=_UnifiedCalls.reference & GATKsHC.genotype=_UnifiedCalls.genotype.';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
CREATE TABLE `GeneticLabRecords` (
  ...
  KEY `source` (`source`),
  KEY `sample_name` (`sample_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Origin place of received samples.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Information from sequencing run. Runs.id=Samples.run_id';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='Row filled by Samples table trigger. To link which samples are called or annotated by which (version of) caller or external sources. Samples2Callers.sample_id=Samples.id. Samples2Callers.caller_id=Callers.id.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Information extract from coverage report - SummaryOutput_ProteinCodingTarget_runname.txt. SampleEnrichments.sample_id=Samples.id.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `SampleStatus` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `sample_id_UNIQUE` (`sample_id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='Row filled by Samples table trigger. A QC for samples. Non-OK = ?';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='Information for sequencing samples. Two triggers related with this table.';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=InnoDB AUTO_INCREMENT=32642 DEFAULT CHARSET=utf8 COMMENT='To store Ensembl VEP annotations. V2Ensembls.uid=_UnifiedCalls.id. V2Ensembls.id=V2Families.vid. V2Ensembls.id=_ClassifiedCalls.vid.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=175380 DEFAULT CHARSET=utf8 COMMENT='To store variant allele frequency. pop_id is from the population table of Ensembl Variation DB.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `V2Phens` (
  ...
  KEY `uid_only` (`uid`),
  KEY `rs_id_only` (`rs_id`)
) ENGINE=InnoDB AUTO_INCREMENT=313 DEFAULT CHARSET=utf8 COMMENT='Phenotype annotations from Ensembl.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=402 DEFAULT CHARSET=utf8 COMMENT='Variants annotated by dbNSFP. ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `V2dbSNPs` (
  ...
  KEY `uid_only` (`uid`),
  KEY `rs_id_only` (`rs_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3441 DEFAULT CHARSET=utf8 COMMENT='Variants annotated by dbSNPs. V2dbSNPs.uid=_UnifiedCalls.id.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=39481 DEFAULT CHARSET=utf8 COMMENT='This table is a short-cut of joined results from Samples, _UnifiedCalls and various callers. _MetaCalls.sample_id=Samples.id. _MetaCalls.uid=_UnifiedCalls.id. _MetaCalls.gatk=GATKs.id';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `_UnifiedCalls` (
  ...
  KEY `is_new` (`is_new`)
) ENGINE=InnoDB AUTO_INCREMENT=4121 DEFAULT CHARSET=utf8 COMMENT='Trigger-filled table - summarize variant information from different caller tables. To consolidate and merge variants regardless of callers. _UnifiedCalls.id=_MetaCalls.uid. _UnifiedCalls.id=V2Ensembls.uid. _UnifiedCalls.id=2PDBs.uid. _UnifiedCalls.id=2UniProts.uid. _UnifiedCalls.id=HasFound.uid. _UnifiedCalls.id=V2dbNSFP.uid.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `core` (
  ...
  KEY `gene` (`gene`(100)),
  KEY `ref_alt` (`ref`,`alt`)
) ENGINE=InnoDB AUTO_INCREMENT=89617786 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-03-17 17:42:50
