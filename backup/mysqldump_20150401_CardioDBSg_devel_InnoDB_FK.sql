...
CREATE TABLE `BiobankRecords` (
  ...
  KEY `Gender` (`Gender`),
  KEY `Race` (`Race`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Disease diagnostic result from Biobank database (obtain from NHCS intranet - manual update weekly).';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Pre-fill table - to store the version of software/database used either for variant calling or annotations. Callers.id=Sample2Callers.caller_id.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Information extract from coverage report - PerOfCallableBy_ProteinCodingTarget_runname_poolname.txt. CodingEnrichments.sample_id=Samples.id.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Pre-filled table - external source to support HasFound. (mirror source table from ensembl_homo_sapiens_variation_75_37?)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Information extract from result of GATK UnifiedGenotyper - samplename.markDup.Realigned.recalibrated.OnTarget.q15.bam.final.UnifiedGenotyper.snp.vcf and indel.vcf. GATKs.sample_id=Samples.id. GATKs.chr=_UnifiedCalls.chr & GATKs.v_start=_UnifiedCalls.v_start & GATKs.v_end=_UnifiedCalls.v_end & GATKs.reference=_UnifiedCalls.reference & GATKs.genotype=_UnifiedCalls.genotype';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Information extract from result of GATK HaplotypeCaller - samplename.markDup.Realigned.recalibrated.OnTarget.q15.bam.final.HaplotypeCaller.snp.vcf and indel.vcf. GATKsHC.sample_id=Samples.id. GATKsHC.chr=_UnifiedCalls.chr & GATKsHC.v_start=_UnifiedCalls.v_start & GATKsHC.v_end=_UnifiedCalls.v_end & GATKsHC.reference=_UnifiedCalls.reference & GATKsHC.genotype=_UnifiedCalls.genotype.';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`cardiodbs`@`127.0.0.1`*/ /*!50003 TRIGGER `insert_UnifiedCalls_after_GATKsHC` AFTER INSERT ON `GATKsHC`
FOR EACH ROW
BEGIN
	INSERT IGNORE INTO _UnifiedCalls
	SET chr=new.chr, v_start=new.v_start, v_end=new.v_end, reference=new.reference, genotype=new.genotype;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Information from sequencing run. Runs.id=Samples.run_id';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Row filled by Samples table trigger. To link which samples are called or annotated by which (version of) caller or external sources. Samples2Callers.sample_id=Samples.id. Samples2Callers.caller_id=Callers.id.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Information extract from coverage report - SummaryOutput_ProteinCodingTarget_runname.txt. SampleEnrichments.sample_id=Samples.id.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Row filled by Samples table trigger. A QC for samples. Non-OK = ?';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Information for sequencing samples. Two triggers related with this table.';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Pre-fill table - assay information for target capture. Targets.id=Samples.target_id.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='To store Ensembl VEP annotations. V2Ensembls.uid=_UnifiedCalls.id. V2Ensembls.id=V2Families.vid. V2Ensembls.id=_ClassifiedCalls.vid.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='To store variant allele frequency. pop_id is from the population table of Ensembl Variation DB.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Phenotype annotations from Ensembl.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Variants annotated by dbSNPs. V2dbSNPs.uid=_UnifiedCalls.id.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='This table is a short-cut of joined results from Samples, _UnifiedCalls and various callers. _MetaCalls.sample_id=Samples.id. _MetaCalls.uid=_UnifiedCalls.id. _MetaCalls.gatk=GATKs.id';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `_UnifiedCalls` (
  ...
  KEY `is_new` (`is_new`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Trigger-filled table - summarize variant information from different caller tables. To consolidate and merge variants regardless of callers. _UnifiedCalls.id=_MetaCalls.uid. _UnifiedCalls.id=V2Ensembls.uid. _UnifiedCalls.id=2PDBs.uid. _UnifiedCalls.id=2UniProts.uid. _UnifiedCalls.id=HasFound.uid. _UnifiedCalls.id=V2dbNSFP.uid.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-04-01 19:17:00
