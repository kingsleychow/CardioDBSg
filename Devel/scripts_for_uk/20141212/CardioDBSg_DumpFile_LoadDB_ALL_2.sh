...
for RUN in ${RUNS}; do 
	...
	for CALLER in ${CALLERS} ;
	  ...
	  PARSER=${CARDIODBS_PATH}/bin/make_${CALLER}_perlconf_2.pl
	...
	perl ${CARDIODBS_PATH}/bin/make_Enrichments_perlconf_2.pl --run_name $RUN --dbconfig $DB_CONFIG --CARDIODB_ROOT ${CARDIODBS_PATH} 2>> log_cardiodbs_$DATE/Enrichment.$DATE.$RUN.log
	echo " =====> Done!";
...
perl ${CARDIODBS_PATH}/bin/make_HasFound_perlconf_2.pl --sql --dbconfig $DB_CONFIG --CARDIODB_ROOT ${CARDIODBS_PATH} --new_entries --check_alleles > ${CARDIODBS_PATH}/Dump/HasFound/HasFound.added.txt 2>> log_cardiodbs_$DATE/HasFound.added.$DATE.log
echo " =====> Done!"
...
perl ${CARDIODBS_PATH}/bin/make_HasFound_perlconf_2.pl --sql --dbconfig $DB_CONFIG --CARDIODB_ROOT ${CARDIODBS_PATH} --new_entries > ${CARDIODBS_PATH}/Dump/HasFound/HasFound.added.colocated.txt 2>> log_cardiodbs_$DATE/HasFound.added.$DATE.log
echo " =====> Done!"
...
perl ${CARDIODBS_PATH}/bin/make_V2Ensembls_perlconf_2.pl --sql --all --new_entries --v2ensx --annotation --dbconfig $DB_CONFIG --CARDIODB_ROOT ${CARDIODBS_PATH} 2>> log_cardiodbs_$DATE/V2Ensembls.$DATE.log
echo " =====> Done!"
