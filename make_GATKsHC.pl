...
=cut
		...
		# /data/results/5500xl/projects/lifescope/CMR000070_20110711_HCM_Pool_2_AND_4/HCM_pool_2_283241/gatk_snp_indel/10DP00127VB/Target/HCM_pool_2_283241.ontarget.bam.final.snp.vcf
			...
			if(-d $result_root.'/'.$run_name.'/'.$pool_name.'_'.$target_id){
				# /data/results/5500xl/projects/lifescope/CMR000070_20131017_IHD2/IHD2_S0411142/gatk_snp_indel/12JR00759/Target/HaplotypeCaller/IHD2_S0411142.ontarget.bam.final.HaplotypeCaller.snp.vcf
				$gatk_snp=$result_root.'/'.$run_name.'/'.$pool_name.'_'.$target_id.'/gatk_snp_indel/'.$sample_name.'/Target/HaplotypeCaller/'.$pool_name.'_'.$target_id.'.ontarget.bam.final.HaplotypeCaller.snp.vcf';
				$gatk_snp=$result_root.'/'.$run_name.'/'.$pool_name.'_'.$target_id.'/gatk_snp_indel/'.$old_sample_name.'/Target/HaplotypeCaller/'.$pool_name.'_'.$target_id.'.ontarget.bam.final.HaplotypeCaller.snp.vcf' unless -s $gatk_snp;


				# /data/results/5500xl/projects/lifescope/CMR000070_20131017_IHD2/IHD2_S0411142/gatk_snp_indel/12JR00759/Target/HaplotypeCaller/IHD2_S0411142.ontarget.bam.final.HaplotypeCaller.indel.vcf
				$gatk_indel=$result_root.'/'.$run_name.'/'.$pool_name.'_'.$target_id.'/gatk_snp_indel/'.$sample_name.'/Target/HaplotypeCaller/'.$pool_name.'_'.$target_id.'.ontarget.bam.final.HaplotypeCaller.indel.vcf';
				$gatk_indel=$result_root.'/'.$run_name.'/'.$pool_name.'_'.$target_id.'/gatk_snp_indel/'.$old_sample_name.'/Target/HaplotypeCaller/'.$pool_name.'_'.$target_id.'.ontarget.bam.final.HaplotypeCaller.indel.vcf' unless -s $gatk_indel;
			...
			$gatk_indel="$pool_dir/gatk_snp_indel/$old_sample_name/Target/HaplotypeCaller/$old_sample_name.markDup.Realigned.recalibrated.OnTarget.q8.bam.final.HaplotypeCaller.indel.vcf" unless -s $gatk_indel;
