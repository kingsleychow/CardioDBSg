      ...
      if($is_snp){
          ...
          foreach my $geno(split(/,/,$genotype)){
              ...
              if(length($reference)==length($geno)){
                  print "0\t$sample_id\t$snp_type\t$chr\t$g_start\t$reference\t$g_start\t$g_start\t$reference\t$geno\t$qual\t$filter\t$known\t$ab\t$ac\t$af\t$an\t$t_dp\t$hrun\t$hscore\t$mq\t$qd\t$sb\t$info\t$gt\t$ad\t$f_dp\t$gq\t$pl\n" unless $DEBUG;
              }else{
          ...
          foreach my $geno(split(/,/,$genotype)){
              ...
              # chr1    85331808    .   GAGAAG  GAGAAGAAG (-/AAG)
                  ...
                  } #end of  if($reference eq substr($geno, 0, length($reference)))
                  else{
              ...
              print "0\t$sample_id\t$snp_type\t$chr\t$g_start\t$reference\t$start\t$end\t$ref\t$mut\t$qual\t$filter\t$known\t$ab\t$ac\t$af\t$an\t$t_dp\t$hrun\t$hscore\t$mq\t$qd\t$sb\t$info\t$gt\t$ad\t$f_dp\t$gq\t$pl\n" unless $DEBUG;
          } #end of foreach
